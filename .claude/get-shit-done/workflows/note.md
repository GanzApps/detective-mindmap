...
- **Global scope**: `C:/workspace/ai-learn/3d graph mindmap/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/workspace/ai-learn/3d graph mindmap/.claude/notes/`)
...
2. Glob `C:/workspace/ai-learn/3d graph mindmap/.claude/notes/*.md` (if directory exists) — global notes
...
Global (C:/workspace/ai-learn/3d graph mindmap/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/workspace/ai-learn/3d graph mindmap/.claude/notes/` — works in any directory
