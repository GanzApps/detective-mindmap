...
See C:/workspace/ai-learn/3d graph mindmap/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using C:/workspace/ai-learn/3d graph mindmap/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using C:/workspace/ai-learn/3d graph mindmap/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from C:/workspace/ai-learn/3d graph mindmap/.claude/get-shit-done/templates/discovery.md
...
Use C:/workspace/ai-learn/3d graph mindmap/.claude/get-shit-done/templates/discovery.md.
