...
<!-- For checkpoint task examples and patterns, see @C:/workspace/ai-learn/3d graph mindmap/.claude/get-shit-done/references/checkpoints.md -->
...
See `C:/workspace/ai-learn/3d graph mindmap/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `C:/workspace/ai-learn/3d graph mindmap/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `C:/workspace/ai-learn/3d graph mindmap/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
