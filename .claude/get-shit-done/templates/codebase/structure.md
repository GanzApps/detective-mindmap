...
- Usage: Reference from command with `@C:/workspace/ai-learn/3d graph mindmap/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to C:/workspace/ai-learn/3d graph mindmap/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to C:/workspace/ai-learn/3d graph mindmap/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
