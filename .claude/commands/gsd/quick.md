...
<execution_context>
@C:/workspace/ai-learn/3d graph mindmap/.claude/get-shit-done/workflows/quick.md
</execution_context>
...
<process>
Execute the quick workflow from @C:/workspace/ai-learn/3d graph mindmap/.claude/get-shit-done/workflows/quick.md end-to-end.
