...
<execution_context>
@C:/workspace/ai-learn/3d graph mindmap/.claude/get-shit-done/workflows/docs-update.md
</execution_context>
...
<process>
Execute the docs-update workflow from @C:/workspace/ai-learn/3d graph mindmap/.claude/get-shit-done/workflows/docs-update.md end-to-end.
