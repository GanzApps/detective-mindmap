...
<execution_context>
@C:/workspace/ai-learn/3d graph mindmap/.claude/get-shit-done/workflows/autonomous.md
...
<process>
Execute the autonomous workflow from @C:/workspace/ai-learn/3d graph mindmap/.claude/get-shit-done/workflows/autonomous.md end-to-end.
