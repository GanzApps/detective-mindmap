...
Use template from `C:/workspace/ai-learn/3d graph mindmap/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/workspace/ai-learn/3d graph mindmap/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "C:/workspace/ai-learn/3d graph mindmap/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
