...
Reference full template: `C:/workspace/ai-learn/3d graph mindmap/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/workspace/ai-learn/3d graph mindmap/.claude/get-shit-done/templates/state.md`.
