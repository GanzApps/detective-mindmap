...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/workspace/ai-learn/3d graph mindmap/.claude
                  → checks C:/workspace/ai-learn/3d graph mindmap/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/workspace/ai-learn/3d graph mindmap/.claude/get-shit-done
                  → writes to C:/workspace/ai-learn/3d graph mindmap/.claude/get-shit-done/hooks/
...
@C:/workspace/ai-learn/3d graph mindmap/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @C:/workspace/ai-learn/3d graph mindmap/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
node "C:/workspace/ai-learn/3d graph mindmap/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "C:/workspace/ai-learn/3d graph mindmap/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
