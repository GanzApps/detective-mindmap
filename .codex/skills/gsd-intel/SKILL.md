...
Intel system is disabled. To activate:
  ...
  node C:/workspace/ai-learn/3d graph mindmap/.codex/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node C:/workspace/ai-learn/3d graph mindmap/.codex/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node C:/workspace/ai-learn/3d graph mindmap/.codex/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node C:/workspace/ai-learn/3d graph mindmap/.codex/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: C:/workspace/ai-learn/3d graph mindmap/.codex/get-shit-done/bin/gsd-tools.cjs
