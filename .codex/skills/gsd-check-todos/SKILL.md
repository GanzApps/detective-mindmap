...
<execution_context>
@C:/workspace/ai-learn/3d graph mindmap/.codex/get-shit-done/workflows/check-todos.md
</execution_context>
...
<process>
**Follow the check-todos workflow** from `@C:/workspace/ai-learn/3d graph mindmap/.codex/get-shit-done/workflows/check-todos.md`.
