...
<execution_context>
@C:/workspace/ai-learn/3d graph mindmap/.codex/get-shit-done/workflows/add-todo.md
</execution_context>
...
<process>
**Follow the add-todo workflow** from `@C:/workspace/ai-learn/3d graph mindmap/.codex/get-shit-done/workflows/add-todo.md`.
