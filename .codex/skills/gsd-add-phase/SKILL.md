...
<execution_context>
@C:/workspace/ai-learn/3d graph mindmap/.codex/get-shit-done/workflows/add-phase.md
</execution_context>
...
<process>
**Follow the add-phase workflow** from `@C:/workspace/ai-learn/3d graph mindmap/.codex/get-shit-done/workflows/add-phase.md`.
