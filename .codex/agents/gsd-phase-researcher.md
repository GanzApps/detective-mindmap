...
```bash
node "C:/workspace/ai-learn/3d graph mindmap/.codex/get-shit-done/bin/gsd-tools.cjs" websearch "your query" --limit 10
```
...
@C:/workspace/ai-learn/3d graph mindmap/.codex/get-shit-done/references/thinking-models-research.md
...
```bash
node "C:/workspace/ai-learn/3d graph mindmap/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): research phase domain" --files "$PHASE_DIR/$PADDED_PHASE-RESEARCH.md"
```
