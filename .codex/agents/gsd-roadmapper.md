...
Reference full template: `C:/workspace/ai-learn/3d graph mindmap/.codex/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/workspace/ai-learn/3d graph mindmap/.codex/get-shit-done/templates/state.md`.
